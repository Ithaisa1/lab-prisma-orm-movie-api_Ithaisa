...
CREATE TABLE "pelicula_actores" (
    ...
    CONSTRAINT "pelicula_actores_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "actores_nombre_key" ON "actores"("nombre");

-- CreateIndex
CREATE UNIQUE INDEX "pelicula_actores_pelicula_id_actor_id_key" ON "pelicula_actores"("pelicula_id", "actor_id");
...
-- AddForeignKey
ALTER TABLE "pelicula_actores" ADD CONSTRAINT "pelicula_actores_pelicula_id_fkey" FOREIGN KEY ("pelicula_id") REFERENCES "peliculas"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pelicula_actores" ADD CONSTRAINT "pelicula_actores_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "actores"("id") ON DELETE CASCADE ON UPDATE CASCADE;
